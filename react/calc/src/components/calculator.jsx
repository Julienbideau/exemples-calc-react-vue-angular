    ...
    return (
           <div id="main">
            <div id="first-rows">
                ...
                <button value="%" onClick={e => this.clickSign(e)}
            ...
            <div className="rows">
                <button value="7" onClick={e => this.clickNumber(e)}
                    className="btn-style num-bg num first-child"
                >
                    7
            </button>
                <button value="8" onClick={e => this.clickNumber(e)}
                    className="btn-style num-bg num"
                >
                    8
            </button>
                <button value="9" onClick={e => this.clickNumber(e)}
                    className="btn-style num-bg num"
                >
                    9
            </button>
            ...
            <div className="rows">
                <button value="4" onClick={e => this.clickNumber(e)}
                    className="btn-style num-bg num first-child"
                >
                    4
            </button>
                <button value="5" onClick={e => this.clickNumber(e)}
                    className="btn-style num-bg num"
                >
                    5
            </button>
                <button value="6" onClick={e => this.clickNumber(e)}
                    className="btn-style num-bg num"
                >
                    6
            </button>
            ...
            <div className="rows">
                <button value="1" onClick={e => this.clickNumber(e)}
                    className="btn-style num-bg num first-child"
                >
                    1
            </button>
                <button value="2" onClick={e => this.clickNumber(e)}
                    className="btn-style num-bg num"
                >
                    2
            </button>
                <button value="3" onClick={e => this.clickNumber(e)}
                    className="btn-style num-bg num"
                >
                    3
            </button>
            ...
            <div className="rows">
                <button value="0" onClick={e => this.clickNumber(e)}
                    className="num-bg zero"
                    id="delete"
                >
                    0
            </button>
                <button value="." onClick={e => this.clickNumber(e)}
